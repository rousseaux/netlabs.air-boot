...
MBRP_Line1      db      'ÕÍÍ´!ATTENTION! -> A V1RU5 WAS FOUND <- !ATTENTION!ÃÍÍ¸'
MBRP_EmptyLine  db      '³                                                     ³'
...
;MBRP_Line3      db      'ÔÍÍÍ´AiR-BOOT (c) Copyright by M. Kiewitz 1999-2009ÃÍÍ¾'
MBRP_Line3      db      'ÔÍÍÍ´AiR-BOOT (c) Copyright by M. Kiewitz 1999-2012ÃÍÍ¾'
